    ...
    >
      <g clipPath="url(#clip0_296_2119)">
        ...
        <g mask="url(#mask0_296_2119)">
          ...
          <path
            d="M12.0701 8.9498C12.0301 8.9498 11.97 8.9498 11.92 8.9498C10.87 8.9098 10.04 8.0598 10.04 6.9998C10.04 5.9198 10.9101 5.0498 11.9901 5.0498C13.0701 5.0498 13.9401 5.9298 13.9401 6.9998C13.9501 8.0598 13.1201 8.9198 12.0701 8.9498Z"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
